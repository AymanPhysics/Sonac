...
Public Class Items2
    Public TableName As String = "Items2"
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        bm.Fields = New String() {SubId, SubName, "Price"}
        bm.control = New Control() {txtID, txtName, Price}
    ...
    Private Sub txtID_KeyUp(sender As Object, e As KeyEventArgs) Handles txtID.KeyUp
        Try
            bm.ShowHelp("Items", txtID, txtName, e, "select Id,Name from " & TableName)
            txtName.Focus()
